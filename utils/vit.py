...
def vit_s16(pretrained, map_location,**kwargs):
    ...
    if not pretrained.startswith("none"):
        load_checkpoint(pretrained, model,map_location)
...
def load_checkpoint(checkpoint_file, model,map_location):
    ...
    #state_dict = checkpoint["model"] #baseline
